# Le icone del widget.
#
# Le forme vengono da Lucide (github.com/lucide-icons/lucide, licenza ISC, libera anche
# per uso commerciale): 1798 icone disegnate tutte sulla stessa griglia 24x24, tratto 2,
# punte tonde. Prenderle da li' invece di disegnarle a mano vuol dire che sono coerenti
# fra loro, e che se domani ne serve un'altra e' gia' pronta e in stile.
#
# Le animazioni le facciamo qui: le calcola WPF, quindi non serve nessuna libreria,
# nessun file sul disco, e non pesano niente. Il tratto che si disegna e' fatto con
# StrokeDashArray; il resto sono rotazioni, spostamenti e opacita' in cerchio chiuso.

$ICONE = @{}

# --- RIPRENDI: la freccia che torna indietro, e si ridisegna ---
$ICONE['riprendi'] = @'
...
# --- SESSIONI: gli strati, che si staccano uno alla volta ---
$ICONE['sessioni'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- AGENTI: il robot, con gli occhi che lampeggiano ---
$ICONE['agenti'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- COLLEGATI: l'antenna, con le onde che partono ---
$ICONE['dispositivi'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- IPHONE: il telefono, con quello che arriva che sale ---
$ICONE['iphone'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- DA FARE: il quadrato, e la spunta che si disegna da sola ---
$ICONE['lavori'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- IMPOSTAZIONI: la ruota dentata, che gira piano ---
$ICONE['impostazioni'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# --- ORA: l'orologio, con la lancetta che gira ---
$ICONE['ora'] = @'
<Canvas xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Width="MISURA" Height="MISURA">
  <Canvas Width="24" Height="24">
...
# Il disegno e' sempre lo stesso: cambia solo come e' vestito e quanto e' grande.
function Icona($nome, $colore = '#E8FFFFFF', $misura = 16, $accento = '#FF5A6B') {
  $testo = $ICONE[$nome]
  if (-not $testo) { return $null }
  $scala = [Math]::Round($misura / 24, 4)
  $testo = $testo.Replace('MISURA', [string]$misura).Replace('SCALA', [string]$scala)
  $testo = $testo.Replace('COLORE', $colore).Replace('ACCENTO', $accento)
  try { [Windows.Markup.XamlReader]::Parse($testo) } catch { $null }
}
